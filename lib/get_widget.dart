        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              GfFormDropDown(values: ['Daily', 'Weekly', 'Monthly', 'Yearly']),
              GFButton(
                size: GFSize.LARGE,
                text: 'View on Github',
                textStyle: const TextStyle(fontSize: 16, color: GFColors.WHITE),
                icon: SvgPicture.asset('assets/github.svg', height: 22),
          ...
          Column(
            children: <Widget>[
              ...
              GFButton(
                ...
                textStyle: const TextStyle(fontSize: 16, color: GFColors.WHITE),
                icon: SvgPicture.asset('assets/playstore.svg', height: 20),
                color: GFColors.SUCCESS,
                blockButton: true,
                onPressed: () {
